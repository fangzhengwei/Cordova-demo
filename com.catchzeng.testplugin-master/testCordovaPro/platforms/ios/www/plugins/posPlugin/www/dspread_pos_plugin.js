...
//               function TestModel2() {};
//
//               TestModel2.prototype.getQposId = function (success,fail,options) {
//                   exec(success, fail, 'dspread_pos_plugin', 'getQposId',options);
//               };
//
//               TestModel2.prototype.scanQPos2Mode = function (success,fail,options) {
//                  exec(success, fail, 'dspread_pos_plugin', 'scanQPos2Mode',options);
//               };
//
